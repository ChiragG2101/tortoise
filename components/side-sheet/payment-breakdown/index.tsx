        ...
        <AccordionItem value="item-1" className="px-4">
          ...
          <AccordionContent>
            ...
            <div className="relative flex py-5 items-center ">
              ...
              <span className="flex-shrink border border-[#FFB5F2] py-1.5 px-4 rounded-full bg-[#FFF1FC] text-[#924790] font-semibold">
                Salary deductions
              </span>
              <div className="flex-grow border-t border-dashed	 border-[#FFB5F2]"></div>
            </div>
            ...
            <div className="mt-4 p-4 rounded-xl bg-secondary ">
              If you approve this request today, you&apos;ll have to deduct
              ₹13,416 from Aditya&apos;s salary from the next payroll cycle
              starting May 2024 till October 2024
            </div>
            <div className="relative flex py-5 items-center ">
              <div className="flex-grow border-t border-dashed	 border-[#BBACFF]"></div>
              <span className="flex-shrink border border-[#BBACFF] py-1.5 px-4 rounded-full bg-[#F1F2FF] text-[#775DB3] font-semibold">
        ...
        <AccordionItem value="item-2" className="px-4">
          ...
          <AccordionContent>
            ...
            <div className="relative flex py-5 items-center ">
              ...
              <span className="flex-shrink border border-[#83EDA8] py-1.5 px-4 rounded-full bg-[#E6FFE6] text-[#167E62] font-semibold">
                Payments to connect
              </span>
              <div className="flex-grow border-t border-dashed	 border-[#83EDA8]"></div>
            </div>
